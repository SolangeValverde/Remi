...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    Random r = new Random();
    RisingImg rshine1, rshine2, rheart1, rheart2;
    int y = r.nextInt(20);
    ...
    ImageView menubg, remiAccessory_imgView, animation, brush, hand, shine1, shine2, heart1, heart2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////
        shine1 = (ImageView) findViewById(R.id.risible);
        rshine1 = new RisingImg(10, 30, this, shine1);
        shine2 = (ImageView) findViewById(R.id.risible2);
        rshine2 = new RisingImg(-20, 20, this, shine2);
...
*/
    ...
    public void brushStarts() {
        ...
        rshine1.setRisingImage(R.drawable.shine);
        rshine2.setRisingImage(R.drawable.shine);
        while (((Math.abs(50 - brush.getX())) < (int)((20+ 512/2))) &&
                (Math.abs(130 - brush.getY())) < (int)((20 + 512/2))) {
           // shine = true;
            //if (shine) {
                shineStarts();
                shineStops();
        ...
        shine1.setVisibility(View.GONE);
        shine2.setVisibility(View.GONE);
    }
    ...
    public void shineStarts() {
        shine1.setVisibility(View.VISIBLE);
        shine2.setVisibility(View.VISIBLE);
        rshine1.draw();
        rshine2.draw();
    }

    public void shineStops() {
        rshine1.fadeOut(shine1);
        rshine2.fadeOut(shine2);
    }
